...
$.init = function () {
    var moduleContainer = $.query('#module');
    var paramMapping = $.getUriParams($.window().get$location().get$search());
    var moduleFqn = $.index(paramMapping, 'module') == null ? 'loxal.epvin.manager.Manager' : $.index(paramMapping, 'module');
    moduleContainer.set$src('/' + $.S(moduleFqn) + '/' + $.S(moduleFqn) + '.nocache.js');
};
