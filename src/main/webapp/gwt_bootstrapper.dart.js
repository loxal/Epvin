...
$$.HashMapImplementation = {"":["_numberOfDeleted", "_numberOfEntries", "_loadLimit", "_values", "_keys?"],
    super:"Object",
    toString$0:function () {
...
$$.HashSetIterator = {"":["_nextValidIndex", "_entries"],
    super:"Object",
    _advance$0:function () {
...
$$.LinkedHashMapImplementation = {"":["_map", "_lib0_list"],
    super:"Object",
    toString$0:function () {
        return $.Maps_mapToString(this);
    },
...
$$.DoubleLinkedQueueEntry = {"":["_lib0_element?", "_next=", "_previous="],
    super:"Object",
...
$$._DoubleLinkedQueueEntrySentinel = {"":["_lib0_element", "_next", "_previous"],
...
$$._DoubleLinkedQueueIterator = {"":["_currentEntry", "_sentinel"],
    super:"Object",
    next$0:function () {
        if (this.hasNext$0() !== true) throw $.captureStackTrace($.CTC1);
...
$$.StringBufferImpl = {"":["_length", "_buffer"],
    super:"Object",
    toString$0:function () {
...
$$.JSSyntaxRegExp = {"":["ignoreCase?", "multiLine?", "pattern?"],
    super:"Object",
...
$$.MatchImplementation = {"":["_groups", "_end", "_start", "str", "pattern?"],
    super:"Object",
...
$$._AllMatchesIterator = {"":["_done", "_next=", "_str", "_re"],
    super:"Object",
    hasNext$0:function () {
...
$$.MetaInfo = {"":["set?", "tags", "tag?"],
    super:"Object"
};

$$.StringMatch = {"":["pattern?", "str", "_lib1_start"],
    super:"Object",
...
$$.NoSuchMethodException = {"":["_existingArgumentNames", "_arguments", "_functionName", "_receiver"],
    super:"Object",
    toString$0:function () {
...
$$.NullPointerException = {"":["arguments", "functionName"],
    super:"Object",
...
$$.IllegalJSRegExpException = {"":["_errmsg", "_pattern"],
    super:"Object",
    toString$0:function () {
...
$$.FilteredElementList = {"":["_childNodes", "_node"],
    super:"Object",
    last$0:function () {
...
$$._ChildrenElementList = {"":["_childElements", "_element?"],
    super:"Object",
    last$0:function () {
...
$$._FrozenElementListIterator = {"":["_index", "_list"],
    super:"Object",
    hasNext$0:function () {
        var t1 = this._index;
...
$$._FixedSizeListIterator = {"":["_lib_length", "_pos", "_array"],
...
$$._Manager = {"":["managers", "mainManager?", "isolates?", "supportsWorkers", "isWorker?", "fromCommandLine?", "topEventLoop?", "rootContext=", "currentContext=", "nextManagerId", "currentManagerId?", "nextIsolateId="],
    super:"Object",
...
$$._IsolateContext = {"":["isolateStatics", "ports?", "id?"],
    super:"Object",
...
$$._WorkerSendPort = {"":["_receivePortId?", "_workerId?", "_isolateId"],
    super:"_BaseSendPort",
    hashCode$0:function () {
...
$$.getUriParams_anon = {"":["paramMapping_0"],
    super:"Closure",
    $call$1:function (e) {
        if ($.contains$1(e, '=') === true) {
            var paramValue = $.split(e, '=');
            $.indexSet(this.paramMapping_0, $.index(paramValue, 0), $.index(paramValue, 1));
        } else $.indexSet(this.paramMapping_0, e, '');
    }
};
...
$.dynamicFunction = function (name$) {
    ...
    var bind = (function () {
        return $.dynamicBind.$call$4(this, name$, methods, Array.prototype.slice.call(arguments));
    });
...
$.init = function () {
    $.base = $._Elements_BaseElement();
    $.base.set$href('/loxal.epvin.manager.Manager');
    $.add$1($.document().get$head().get$elements(), $.base);
    $.moduleContainer = $._Elements_ScriptElement();
    ...
    $.moduleContainer.set$async(true);
    $.moduleContainer.set$defer(true);
    $.moduleContainer.set$type('text/javascript');
    $.moduleContainer.set$src(moduleSrc);
    $.add$1($.document().get$head().get$elements(), $.moduleContainer);
    $.print('gwtModule: ' + $.S($.moduleContainer.get$src()));
};
...
$.dynamicBind = function (obj, name$, methods, arguments$) {
    ...
    if (method == null) method = (function () {
        if (Object.getPrototypeOf(this) === proto) {
            $.throwNoSuchMethod.$call$3(this, name$, Array.prototype.slice.call(arguments));
        } else {
...
$._Elements_BaseElement = function () {
...
$.getUriParams = function (uriSearch) {
    if (!$.eqB(uriSearch, '')) {
        var paramValuePairs = $.split($.substring$1(uriSearch, 1), '&');
        var paramMapping = $.HashMapImplementation$();
        $.forEach(paramValuePairs, new $.getUriParams_anon(paramMapping));
        return paramMapping;
    }
    return;
};
...
$.defineProperty(Object.prototype, 'is$Element', function () {
    return false;
});
$.defineProperty(Object.prototype, 'is$JavaScriptIndexingBehavior', function () {
    return false;
});
$.defineProperty(Object.prototype, 'is$Collection', function () {
    return false;
});
$.defineProperty(Object.prototype, 'is$List', function () {
    return false;
});
$.defineProperty(Object.prototype, 'is$Map', function () {
    return false;
});
$.defineProperty(Object.prototype, 'is$Location', function () {
    return false;
});
$.defineProperty(Object.prototype, 'toString$0', function () {
    return $.toStringForNativeObject(this);
});
$.$defineNativeClass('HTMLAnchorElement', ["type!", "search?", "href!"], {
    toString$0:function () {
...
$.$defineNativeClass('HTMLAreaElement', ["search?", "href!"], {
    is$Element:function () {
        return true;
    }
});
...
$.$defineNativeClass('HTMLLinkElement', ["type!", "href!"], {
    is$Element:function () {
        return true;
    }
});

$.$defineNativeClass('Location', ["search?", "href!"], {
    toString$0:function () {
        return this.toString();
    },
    is$Location:function () {
...
$.$defineNativeClass('HTMLScriptElement', ["type!", "src=", "defer!", "async!"], {
    is$Element:function () {
        return true;
    }
});
