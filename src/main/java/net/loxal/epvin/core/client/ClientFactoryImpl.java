...
import net.loxal.epvin.core.client.mvp.AppActivityMapper;
import net.loxal.epvin.core.client.mvp.AppPlaceHistoryMapper;
import net.loxal.epvin.core.client.place.EmployeePlace;
import net.loxal.epvin.core.client.ui.EmployeeView;
import net.loxal.epvin.core.client.ui.EmployeeViewImpl;
